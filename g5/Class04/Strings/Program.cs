...
namespace Strings
{
    class Program
	{
		...
		static void Main(string[] args)
		{
            ...
            var path = @"C:\Users\UserName.UserLastName\Documents\Visual Studio 2017\Templates\ItemTemplates";
            var tab = "The \t sign means tab";
			...
			string myStringPercent = string.Format("{0:P}", .7);

			// custom format for string
			string myStringCustom = string.Format("{0:0##-###-###}", 070111222);
